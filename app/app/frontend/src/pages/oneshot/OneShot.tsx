    ...
    return (
        <div className={styles.oneshotContainer}>
            <div className={styles.oneshotTopSection}>
                ...
                <h1 className={styles.oneshotTitle}>Ask your COM 2022 and ABS 216 and 2021 data</h1>
                <div className={styles.oneshotQuestionInput}>
                    <QuestionInput
                        placeholder="Example: summarise the issues in the report about the tram pole. what was the staff reccomendation?"
                        disabled={isLoading}
